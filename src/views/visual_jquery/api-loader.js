...
// set this to true to be able to use Visual jQuery offline
var useOffline = false;

var blank_iframe = '/index-blank.html';
var example_jquery = 'http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js'; // latest from google
if (useOffline == true) example_jquery = 'jquery-1.3.2.js';
...
function iframeTemplate() {
    ...
    return [
        ...
        '<' + 'html>', 
        '<' + 'head>', 
        (useOffline ? '' : '<base href="http://docs.jquery.com" />'), 
